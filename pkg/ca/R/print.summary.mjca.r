################################################################################
# 
# print.summary.mjca: (Generic) function for printing summarized 'ca'-objects
#
#      Input: x The 'mjca' object which should be summarized
#
#     Output: summary method for 'mjca' object
# 
################################################################################
